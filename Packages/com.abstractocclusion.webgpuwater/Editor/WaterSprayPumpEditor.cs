    ...
    internal sealed class WaterSprayPumpEditor : UnityEditor.Editor
    {
        ...
        void DrawStaleProbeWarning(WaterSprayPump pump)
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "the water. Re-place them at the current size (or re-run Fit Spray To Hull), or raise Surface " +
        ...
        void DrawPetalReadout()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "as a full circle has no direction - use the Water Wizard's Fit Spray To Hull to give it " +
        ...
        void WriteProbes(Vector3[] localOffsets, WaterSprayMode mode)
            => WriteProbes(serializedObject, localOffsets, mode);
        ...
        internal static void WriteProbes(SerializedObject pumpObject, Vector3[] localOffsets,
                                         WaterSprayMode mode, Vector3[] outwardLocals = null)
        {
            pumpObject.Update();
